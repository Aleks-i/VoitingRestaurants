...
public class DishesTestData {
    ...
    public static final Dish DISH1 = new Dish(DISHES_ID, "пирог", new BigDecimal("150.56"));
    public static final Dish DISH2 = new Dish(DISHES_ID + 1, "десерт", new BigDecimal("200.13"));
    public static final Dish DISH3 = new Dish(DISHES_ID + 2, "чай", new BigDecimal("100.05"));

    public static final List<Dish> DISHES_FOR_RESTAURANT_1 = List.of(DISH1, DISH2, DISH3);

    public static Dish getNewDish() {
        return new Dish(null, "NewDish", new BigDecimal("220.45"));
    }
}
