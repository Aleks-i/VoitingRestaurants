...
public class DishesTestData {
    public static TestMatcher<Dish> MEAL_MATCHER = TestMatcher.usingFieldsWithIgnoringAssertions(Dish.class, "admin");
    ...
    public static Dish getNewDish() {
        return new Dish(null, "NewDish", 220.45, LocalDate.of(2020, 9, 13));
    }
}
